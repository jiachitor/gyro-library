...
}], ["德赛", /\bdesay ([a-z0-9]+)/], ["蓝魔", /\bramos([a-z0-9]+)/], ["美图", /\bmeitu(\d+) build/], ["opsson", /\bopsson ([a-z0-9]+)/], ["benwee", /\bbenwee ([a-z0-9]+)/], ["hosin", /\bhosin ([a-z0-9]+)/], ["smartisan", /\bsmartisan\b/], ["ephone", /ephone ([a-z0-9]+)/], ["佰事讯", /\b(wx9) build/], ["newman", /; newman ([a-z0-9]+) build/],
// 康佳
["konka", function (ua) {
...
var OS = [["smartisanos", /\bsmartisan os \- ([\d.]+)/], ["meego", /\bmeego\b/]];
